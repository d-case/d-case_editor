 ...
 */
public class CopySubtreeContributionItem extends SelectModuleContributionItem {
	/**
	 * Constructor for the class. Creates a CopyModuleContributionItem.
	 */
	public CopySubtreeContributionItem() {
		super();
	}
	 ...
	 */
	public CopySubtreeContributionItem(String id) {
		super(id);
	}
