 ...
 */
public class SetPrivateFlagHandler extends AbstractEditPartHandler {

	private final static String SET_FLAG_CMD_LABEL = "command for unsetting public flag"; //$NON-NLS-1$
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selectedElement != null) {
			...
			if (basicNode != null) {
				...
				flags = flags.replaceAll(publicFlag, "");
