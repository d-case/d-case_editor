...
import net.dependableos.dcase.diagram.editor.logic.xmlconv.XmlConversionToSacmLogic;
...
/**
 * Creates the SACM file from the GMF model file.
 */
public class XmlConversionToSacmRunnable implements IRunnableWithProgress {
     ...
     */
    public XmlConversionToSacmRunnable(IFile inputFile, IFile outputFile,
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException,
        ...
        try {
            ...
            XmlConversionToSacmLogic conversionLogic = new XmlConversionToSacmLogic(
