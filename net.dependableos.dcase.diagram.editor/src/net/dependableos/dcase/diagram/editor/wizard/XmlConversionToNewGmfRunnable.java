...
import net.dependableos.dcase.diagram.editor.logic.xmlconv.XmlConversionToNewGmfLogic;
 ...
 */
public class XmlConversionToNewGmfRunnable implements IRunnableWithProgress {
     ...
     */
    public XmlConversionToNewGmfRunnable(IFile inputFile, IFile outputFile,
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException,
        ...
        try {
            ...
            // converts
            XmlConversionToNewGmfLogic conversionLogic = new XmlConversionToNewGmfLogic(
                    inputFile, outputFile, overwriteOption);
            conversionLogic.convert();

        } catch (DcaseRuntimeException e) {
            e.setMessageType(MessageTypeImpl.CONVERT_TO_NEWGMF_FAILED);
