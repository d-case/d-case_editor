...
/**
 * This is the item provider adapter for a {@link net.dependableos.dcase.Goal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Goal_score_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Goal_score_feature", "_UI_Goal_type"),
                 DcasePackage.Literals.GOAL__SCORE,
                 false,
                 false,
                 false,
    ...
    protected void addWeightPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Goal_weight_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Goal_weight_feature", "_UI_Goal_type"),
                 DcasePackage.Literals.GOAL__WEIGHT,
                 true,
                 false,
                 false,
