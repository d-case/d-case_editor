 ...
 * @generated
 */
public class DcaseMarkerNavigationProvider extends
        AbstractModelMarkerNavigationProvider {

    /**
     * @generated
     */
    public static final String MARKER_TYPE = DcaseDiagramEditorPlugin.ID
    ...
    protected void doGotoMarker(IMarker marker) {
        ...
        if (targetEditPart != null) {
            DcaseDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
