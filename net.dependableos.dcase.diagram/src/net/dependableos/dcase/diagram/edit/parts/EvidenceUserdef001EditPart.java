 ...
 * @generated
 */
public class EvidenceUserdef001EditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public EvidenceUserdef001EditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.EvidenceUserdef001EditPart.VISUAL_ID));
        }
        return parser;
    }
