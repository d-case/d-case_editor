 ...
 * @generated
 */
public class Userdef005ResponsibilityEditPart extends
		DcaseNodeResponsibilityEditPart {

	public static final int VISUAL_ID = 4068; // set manually...

	public Userdef005ResponsibilityEditPart(View view) {
		super(view);
	}
			...
			parser = DcaseParserProvider
					.getParser(
							...
							DcaseVisualIDRegistry
									.getType(net.dependableos.dcase.diagram.edit.parts.Userdef005ResponsibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
