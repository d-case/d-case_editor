 ...
 * @generated
 */
public class SystemUserdef001EditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public SystemUserdef001EditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.SystemUserdef001EditPart.VISUAL_ID));
        }
        return parser;
    }
