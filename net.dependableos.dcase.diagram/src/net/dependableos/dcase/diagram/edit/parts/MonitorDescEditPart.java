 ...
 * @generated
 */
public class MonitorDescEditPart extends DcaseNodeDescEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public MonitorDescEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.MonitorDescEditPart.VISUAL_ID));
        }
        return parser;
    }
