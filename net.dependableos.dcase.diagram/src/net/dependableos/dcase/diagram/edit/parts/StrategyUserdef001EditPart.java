 ...
 * @generated
 */
public class StrategyUserdef001EditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public StrategyUserdef001EditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.StrategyUserdef001EditPart.VISUAL_ID));
        }
        return parser;
    }
