 ...
 * @generated
 */
public class Userdef001AttachmentEditPart extends DcaseNodeDescEditPart
		implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4067; // set manually...
	 ...
	 * @generated
	 */
	public Userdef001AttachmentEditPart(View view) {
		super(view);
	}
			...
			parser = DcaseParserProvider
					.getParser(
							...
							DcaseVisualIDRegistry
									.getType(net.dependableos.dcase.diagram.edit.parts.Userdef001AttachmentEditPart.VISUAL_ID));
		}
		return parser;
	}
