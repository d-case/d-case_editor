 ...
 * @generated
 */
public class JustificationDescEditPart extends DcaseNodeDescEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public JustificationDescEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.JustificationDescEditPart.VISUAL_ID));
        }
        return parser;
    }
