 ...
 * @generated
 */
public class PolicyDescEditPart extends DcaseNodeDescEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public PolicyDescEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.PolicyDescEditPart.VISUAL_ID));
        }
        return parser;
    }
