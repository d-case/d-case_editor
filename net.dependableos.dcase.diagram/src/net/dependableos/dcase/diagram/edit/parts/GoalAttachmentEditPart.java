 ...
 * @generated
 */
public class GoalAttachmentEditPart extends DcaseNodeDescEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public GoalAttachmentEditPart(View view) {
		super(view);
	}
			...
			parser = DcaseParserProvider
					.getParser(
							...
							DcaseVisualIDRegistry
									.getType(net.dependableos.dcase.diagram.edit.parts.GoalAttachmentEditPart.VISUAL_ID));
		}
		return parser;
	}
