 ...
 * @generated
 */
public class EvidenceNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public EvidenceNameEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.EvidenceNameEditPart.VISUAL_ID));
        }
        return parser;
    }
