 ...
 * @generated
 */
public class Userdef005AttachmentEditPart extends DcaseNodeDescEditPart
		implements ITextAwareEditPart {

	/**
	 * @generated
	 */
	public static final int VISUAL_ID = 4065; // set manually...
	 ...
	 * @generated
	 */
	public Userdef005AttachmentEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DcaseParserProvider
					.getParser(
							DcaseElementTypes.Userdef005_1014,
							getParserElement(),
							DcaseVisualIDRegistry
									.getType(net.dependableos.dcase.diagram.edit.parts.Userdef005AttachmentEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			...
			setManager(new TextDirectEditManager(this,
					...
					DcaseEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
