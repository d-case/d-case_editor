 ...
 * @generated
 */
public class SystemUserdef002EditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public SystemUserdef002EditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.SystemUserdef002EditPart.VISUAL_ID));
        }
        return parser;
    }
