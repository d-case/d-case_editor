 ...
 * @generated
 */
public class ContextUserdef001EditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public ContextUserdef001EditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.ContextUserdef001EditPart.VISUAL_ID));
        }
        return parser;
    }
