 ...
 * @generated
 */
public class GoalDescEditPart extends DcaseNodeDescEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public GoalDescEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.GoalDescEditPart.VISUAL_ID));
        }
        return parser;
    }
