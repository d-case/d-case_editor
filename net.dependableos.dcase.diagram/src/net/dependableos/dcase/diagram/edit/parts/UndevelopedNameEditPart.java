 ...
 * @generated
 */
public class UndevelopedNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public UndevelopedNameEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.UndevelopedNameEditPart.VISUAL_ID));
        }
        return parser;
    }
