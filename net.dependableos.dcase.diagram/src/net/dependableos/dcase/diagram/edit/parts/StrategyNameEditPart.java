 ...
 * @generated
 */
public class StrategyNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public StrategyNameEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.StrategyNameEditPart.VISUAL_ID));
        }
        return parser;
    }
