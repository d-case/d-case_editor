 ...
 * @generated
 */
public class SystemNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public SystemNameEditPart(View view) {
        super(view);
    }
            ...
            parser = DcaseParserProvider
                    .getParser(
                            ...
                            DcaseVisualIDRegistry
                                    .getType(net.dependableos.dcase.diagram.edit.parts.SystemNameEditPart.VISUAL_ID));
        }
        return parser;
    }
