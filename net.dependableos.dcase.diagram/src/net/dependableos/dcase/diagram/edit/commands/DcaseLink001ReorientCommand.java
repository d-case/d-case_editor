 ...
 * @generated
 */
public class DcaseLink001ReorientCommand extends EditElementCommand {
     ...
     * @generated
     */
    public DcaseLink001ReorientCommand(ReorientRelationshipRequest request) {
    ...
    public boolean canExecute() {
        if (false == getElementToEdit() instanceof DcaseLink001) {
            return false;
        }
    ...
    protected boolean canReorientSource() {
        ...
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink001_3001(container, getNewSource(), target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        Argument container = (Argument) getLink().eContainer();
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink001_3001(container, source, getNewTarget());
    }
     ...
     * @generated
     */
    protected DcaseLink001 getLink() {
        return (DcaseLink001) getElementToEdit();
    }
