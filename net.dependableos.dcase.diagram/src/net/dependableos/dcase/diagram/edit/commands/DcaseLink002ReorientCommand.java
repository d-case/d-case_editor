 ...
 * @generated
 */
public class DcaseLink002ReorientCommand extends EditElementCommand {
     ...
     * @generated
     */
    public DcaseLink002ReorientCommand(ReorientRelationshipRequest request) {
    ...
    public boolean canExecute() {
        if (false == getElementToEdit() instanceof DcaseLink002) {
            return false;
        }
    ...
    protected boolean canReorientSource() {
        ...
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink002_3002(container, getNewSource(), target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        Argument container = (Argument) getLink().eContainer();
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink002_3002(container, source, getNewTarget());
    }
     ...
     * @generated
     */
    protected DcaseLink002 getLink() {
        return (DcaseLink002) getElementToEdit();
    }
