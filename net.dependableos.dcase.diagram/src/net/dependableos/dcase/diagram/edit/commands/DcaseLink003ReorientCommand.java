 ...
 * @generated
 */
public class DcaseLink003ReorientCommand extends EditElementCommand {
    ...
    public boolean canExecute() {
        if (false == getElementToEdit() instanceof DcaseLink003) {
            return false;
        }
    ...
    protected boolean canReorientSource() {
        ...
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink003_3003(container, getNewSource(), target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        Argument container = (Argument) getLink().eContainer();
        return DcaseBaseItemSemanticEditPolicy.LinkConstraints
                .canExistDcaseLink003_3003(container, source, getNewTarget());
    }
     ...
     * @generated
     */
    protected DcaseLink003 getLink() {
        return (DcaseLink003) getElementToEdit();
    }
