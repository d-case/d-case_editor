 ...
 * @generated
 */
public class DcaseNavigatorActionProvider extends CommonActionProvider {
    ...
    private class OpenDiagramAction extends Action {
        ...
        public final void selectionChanged(IStructuredSelection selection) {
            ...
            if (selection.size() == 1) {
                ...
                if (selectedElement instanceof DcaseNavigatorItem) {
                    selectedElement = ((DcaseNavigatorItem) selectedElement)
                            .getView();
        ...
        public void run() {
            ...
            try {
                page.openEditor(editorInput, DcaseDiagramEditor.ID);
